...
This document provides a structured overview of the **Fleet Command** project, detailing implemented features, ongoing work, and planned enhancements.
...
> - Contributions, suggestions, and improvement proposals are encouraged via [GitHub issues](https://github.com/marseilodev/battleship/issues) or discussions.
