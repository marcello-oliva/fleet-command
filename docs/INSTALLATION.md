...
This guide provides detailed instructions for building, testing, and installing **Fleet Command**, a modern C++ implementation of the classic battleship game, using **CMake presets** and GitHub Actions workflows.
...
Before building **Fleet Command**, ensure that the following software components are installed and properly configured:
...
Fleet Command relies on **CMake Presets**, defined in the repository-root configuration file [`CMakePresets`](../CMakePresets.json), to provide standardized, reproducible, and portable build configurations across development, testing, and release environments.
